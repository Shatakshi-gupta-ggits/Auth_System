...
- Optional profile fields: `profilePic`, `dob`, `monthlySalary`
...
- `POST /api/auth/signup` (multipart/form-data)
  ...
  - Optional: `role`, `dob`, `monthlySalary`, `profilePic`
...
- `PATCH /api/admin/users/:id` (can update `name`, `dob`, `monthlySalary`, `profilePic`)
